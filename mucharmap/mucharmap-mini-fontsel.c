...
static void mucharmap_mini_font_selection_class_init (MucharmapMiniFontSelectionClass *klass);
static void mucharmap_mini_font_selection_init       (MucharmapMiniFontSelection *fontsel);
static void mucharmap_mini_font_selection_finalize   (GObject *object);

G_DEFINE_TYPE (MucharmapMiniFontSelection, mucharmap_mini_font_selection, GTK_TYPE_HBOX)
...
static int
get_font_size (MucharmapMiniFontSelection *fontsel)
{
...
/* size is in points */
static void
set_font_size (MucharmapMiniFontSelection *fontsel,
	           int size)
{
...
static void
mucharmap_mini_font_selection_set_property (GObject *object,
	                                        guint prop_id,
	                                        const GValue *value,
	                                        GParamSpec *pspec)
{
  ...
  switch (prop_id) {
	case PROP_FONT_DESC:
	  mucharmap_mini_font_selection_set_font_desc (mini_fontsel, g_value_get_boxed (value));
	  break;
	default:
...
static void
mucharmap_mini_font_selection_get_property (GObject *object,
	                                        guint prop_id,
	                                        GValue *value,
	                                        GParamSpec *pspec)
{
  ...
  switch (prop_id) {
	case PROP_FONT_DESC:
	  g_value_set_boxed (value, mucharmap_mini_font_selection_get_font_desc (mini_fontsel));
	  break;
	default:
	  G_OBJECT_WARN_INVALID_PROPERTY_ID (object, prop_id, pspec);
	  break;
...
static void
mucharmap_mini_font_selection_class_init (MucharmapMiniFontSelectionClass *klass)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (klass);

  gobject_class->finalize = mucharmap_mini_font_selection_finalize;
  gobject_class->get_property = mucharmap_mini_font_selection_get_property;
  gobject_class->set_property = mucharmap_mini_font_selection_set_property;
...
GtkWidget *
mucharmap_mini_font_selection_new (void)
{
  return GTK_WIDGET (g_object_new (mucharmap_mini_font_selection_get_type (),
	                               NULL));
}
