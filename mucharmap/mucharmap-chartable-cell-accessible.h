...
//{
	#define GUCHARMAP_TYPE_CHARTABLE_CELL_ACCESSIBLE             (mucharmap_chartable_cell_accessible_get_type ())
	#define GUCHARMAP_CHARTABLE_CELL_ACCESSIBLE(o)               (G_TYPE_CHECK_INSTANCE_CAST ((o), GUCHARMAP_TYPE_CHARTABLE_CELL_ACCESSIBLE, MucharmapChartableCellAccessible))
	#define GUCHARMAP_CHARTABLE_CELL_ACCESSIBLE_CLASS(k) (G_TYPE_CHECK_CLASS_CAST((k), GUCHARMAP_TYPE_CHARTABLE_CELL_ACCESSIBLE, MucharmapChartableCellAccessibleClass))
	...
	#define GUCHARMAP_CHARTABLE_CELL_ACCESSIBLE_GET_CLASS(o)     (G_TYPE_INSTANCE_GET_CLASS ((o), GUCHARMAP_TYPE_CHARTABLE_CELL_ACCESSIBLE, MucharmapChartableCellAccessibleClass))
